...
def get_args():
    ...
    parser.add_argument('-au', '--augment', dest='augment', type=float, default=0, 
                        help='Augmenting or not')
    parser.add_argument('-an', '--angle', dest='angle', type=float, default=180, 
                        help='Angle of augment during self contrastive(Graph Constraint)')
    ...
    parser.add_argument('-s', '--source_label', dest='source_label', type=str, default='', 
                        help='Label path of source data')
    parser.add_argument('-t', '--target_label', dest='target_label', type=str, default='', 
                        help='Pseudo-label path of target data')
    parser.add_argument('-tu', '--target_unlabel', dest='target_unlabel', type=str, default='', 
                        help='Path of target data without pseudo-label')
    parser.add_argument('-i', '--imgs', dest='Imgs', type=str, default='', help='File path of images')
    parser.add_argument('-pb', '--path_backbone', dest='path_backbone', type=str, default='', 
                        help='the path of backbone')
    parser.add_argument('-pt', '--path_transformer', dest='path_transformer', type=str, default='', 
                        help='the path of transformer part')
    parser.add_argument('-ph', '--path_head', dest='path_head', type=str, default='',  
                        help='the path of head part')
    parser.add_argument('--graph_model', '-g', default='', metavar='FILE', 
                        help="Graph model")
    parser.add_argument('-d', '--dir_checkpoint', dest='ckp', type=str, default='', 
    ...
    # for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                loss = criterion_self(pred1, pred2, true_heatmaps, true_heatmaps_t, self_supvision)
